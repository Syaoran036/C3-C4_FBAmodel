...
#       #constrain Glycine and Serine plasmodesmata exchange 
      ...
      #IDH constrain
      uppbnd(C4FBAmodel.const)[which(react_id(C4FBAmodel.const)=="R00709_m")] <- vCres$IDH
      lowbnd(C4FBAmodel.const)[which(react_id(C4FBAmodel.const)=="R00709_m")] <- vCres$IDH
      uppbnd(C4FBAmodel.const)[which(react_id(C4FBAmodel.const)=="R00709_mb")] <- vCres$IDH
      lowbnd(C4FBAmodel.const)[which(react_id(C4FBAmodel.const)=="R00709_mb")] <- vCres$IDH
