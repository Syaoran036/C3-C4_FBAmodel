...
vC.C3C4.FBA<-function(pars,
                      ...
                      Om,
                      Etot,
                      mechModFile="C:/Users/David/Documents/Bio/PhD/Models/von Caemmerer C3-C4/Fitness Landscape/Kinetic RubisCO Pars dependent on kcat/vC C3C4 Cm Landscape model Rubisco pars kcat dependent FAST.r",
                      FBAmodelorg,
