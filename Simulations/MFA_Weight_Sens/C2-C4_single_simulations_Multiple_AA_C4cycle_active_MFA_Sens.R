#240414
# can't work with the vC_FBA_weight_Sens() function because vC-Model parameters have to be reset

plasmo.Weights<-c(1, 1.1, 2, 3, 4, 5)
...
sens_res<-list("plasmo.Weights"=plasmo.Weights,
               "raw.res"=raw.res,
               "plasmo.res"=plasmo.res,
               "C4.res"=C4.res,
               "modelOrgObj"=C4FBAmodel.const.NADPME)
save(sens_res,
     file="PlasmoWeightSensResult_Multiple_AAs_C4Cycle_active_1to5")
