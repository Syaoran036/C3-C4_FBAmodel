...
sens_res<-vC_FBA_weight_Sens(
  constraint_file="Constraints/reactionConstraintsBMobj_NADPMEC2-C4_Multiple_AAs_wo_aKG_Glu.tsv",
  weight_vec=c(1, 1.1, 2, 3, 4, 5)#c(1, 1.1, 5, 10, 50, 100)
)

#save(sens_res,file="PlasmoWeightSensResult_wo_aKG_Glu_1to5")
...
# FBAmodFile="model/C4GEM_maize model_H2Oplasmo_C2.xml"
# constFile.NADPME="C:/Users/David/Documents/Bio/PhD/Models/Gomes de Oliveira Model/vC_FBA_1_2013/C2toC4/Resubmission_Elife/Constraints/reactionConstraintsBMobj_NADPMEC2-C4_Multiple_AAs_wo_aKG_Glu.tsv"
...
# load("C:/Users/David/Documents/Bio/PhD/Models/Gomes de Oliveira Model/vC_FBA_1_2013/C2toC4/Resubmission_Elife/Models/C4GEM_maize model_H2Oplasmo_C2.rfile")
# 
...
# source(file="C:/Users/David/Documents/Bio/PhD/Models/Gomes de Oliveira Model/vC_FBA_1_2013/C2toC4/Resubmission_Elife/Models/vC_C4GEM_coupled_NADPME.R")
# 
# # source Monte carlo Parameters, those include C,O and Etot
# source("C:/Users/David/Documents/Bio/PhD/Models/Gomes de Oliveira Model/vC_FBA_1_2013/C2toC4/Resubmission_Elife/Parameters/MonteCarloParametersCmDep_FlaveriaRangesAliData712_equalSteps.R")
# 
...
# 
# 
# plasmo.Weights<-c(1, 1.1, 5, 10, 50, 100)
...
#                       Om=O,
#                       Etot=Etot,
#                       mechModFile="C:/Users/David/Documents/Bio/PhD/Models/Gomes de Oliveira Model/vC_FBA_1_2013/C2toC4/Resubmission_Elife/Models/vC C3C4 Cm Landscape model Rubisco pars kcat dependent FAST.r",
...
# 
# 
# save(plasmo.Weights,raw.res,plasmo.res,C4.res,file="PlasmoWeightSensResult_wo_aKG_Glu")
# 
