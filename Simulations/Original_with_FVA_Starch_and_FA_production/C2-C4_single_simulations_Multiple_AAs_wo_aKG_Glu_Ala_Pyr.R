...
constFile.NADPME="Constraints/reactionConstraintsBMobj_NADPMEC2-C4_Multiple_AAs_wo_aKG_Glu_Ala_Pyr.tsv"
...
save(vCFBAres,file="vCFBAres_Multiple_AAs_wo_aKG_Glu_Ala_Pyr")
