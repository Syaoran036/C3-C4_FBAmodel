...
source(file="Models/vC_C4GEM_coupled_NADPME_WO_C2_Cycle_Constraints.R")
...
lowbnd(C4FBAmodel.const.NADPME)[which(react_id(C4FBAmodel.const.NADPME)=="TMBgly")]
uppbnd(C4FBAmodel.const.NADPME)[which(react_id(C4FBAmodel.const.NADPME)=="TMBgly")]

lowbnd(C4FBAmodel.const.NADPME)[which(react_id(C4FBAmodel.const.NADPME)=="TMBser")]
uppbnd(C4FBAmodel.const.NADPME)[which(react_id(C4FBAmodel.const.NADPME)=="TMBser")]
# mito GDC:
lowbnd(C4FBAmodel.const.NADPME)[which(react_id(C4FBAmodel.const.NADPME)=="R01221_mb")]
uppbnd(C4FBAmodel.const.NADPME)[which(react_id(C4FBAmodel.const.NADPME)=="R01221_mb")]

lowbnd(C4FBAmodel.const.NADPME)[which(react_id(C4FBAmodel.const.NADPME)=="R01221_m")]
uppbnd(C4FBAmodel.const.NADPME)[which(react_id(C4FBAmodel.const.NADPME)=="R01221_m")]



vCFBAres<-vC.C3C4.FBA_wo_C2(pars=parms,
                      Cm=C,
                      Om=O,
                      Etot=Etot,
...
#load("vCFBAres_Multiple_AAs_WO_C2_Cycle_Constraints")
#save(vCFBAres,file="vCFBAres_Multiple_AAs_WO_C2_Cycle_Constraints_No_Gly_Ser_CO2_Diff")
...
####
# follow photorespiration:
Pglyc.p.ids <- get.Met.react_id( C4FBAmodel.const.NADPME, "2_45_Phosphoglycolate[p]" )
get.flux.by.react_id(C4FBAmodel.const.NADPME, Pglyc.p.ids, vCFBAres.flux, min= varMinMax[,2], max= varMinMax[,3] )

glyc.p.ids <- get.Met.react_id( C4FBAmodel.const.NADPME, "Glycolate[p]" )
get.flux.by.react_id(C4FBAmodel.const.NADPME, glyc.p.ids, vCFBAres.flux, min= varMinMax[,2], max= varMinMax[,3] )

glyc.c.ids <- get.Met.react_id( C4FBAmodel.const.NADPME, "Glycolate[c]" )
get.flux.by.react_id(C4FBAmodel.const.NADPME, glyc.c.ids, vCFBAres.flux, min= varMinMax[,2], max= varMinMax[,3] )

glyc.x.ids <- get.Met.react_id( C4FBAmodel.const.NADPME, "Glycolate[x]" )
get.flux.by.react_id(C4FBAmodel.const.NADPME, glyc.x.ids, vCFBAres.flux, min= varMinMax[,2], max= varMinMax[,3] )

glyx.x.ids <- get.Met.react_id( C4FBAmodel.const.NADPME, "Glyoxylate[x]" )
get.flux.by.react_id(C4FBAmodel.const.NADPME, glyx.x.ids, vCFBAres.flux, min= varMinMax[,2], max= varMinMax[,3] )

glycine.x.ids <- get.Met.react_id( C4FBAmodel.const.NADPME, "Glycine[x]" )
get.flux.by.react_id(C4FBAmodel.const.NADPME, glycine.x.ids, vCFBAres.flux, min= varMinMax[,2], max= varMinMax[,3] )

glycine.c.ids <- get.Met.react_id( C4FBAmodel.const.NADPME, "Glycine[c]" )
get.flux.by.react_id(C4FBAmodel.const.NADPME, glycine.c.ids, vCFBAres.flux, min= varMinMax[,2], max= varMinMax[,3] )

glycine.cb.ids <- get.Met.react_id( C4FBAmodel.const.NADPME, "Glycine[cb]" )
get.flux.by.react_id(C4FBAmodel.const.NADPME, glycine.cb.ids, vCFBAres.flux, min= varMinMax[,2], max= varMinMax[,3] )

Ser.cb.ids <- get.Met.react_id( C4FBAmodel.const.NADPME, "L_45_Serine[cb]" )
get.flux.by.react_id(C4FBAmodel.const.NADPME, Ser.cb.ids, vCFBAres.flux, min= varMinMax[,2], max= varMinMax[,3] )

# why is GlyHMT reaction localized in the BS??
lowbnd(C4FBAmodel.const.NADPME)[which(react_id(C4FBAmodel.const.NADPME)=="R00945_cb")]
uppbnd(C4FBAmodel.const.NADPME)[which(react_id(C4FBAmodel.const.NADPME)=="R00945_cb")]

lowbnd(C4FBAmodel.const.NADPME)[which(react_id(C4FBAmodel.const.NADPME)=="R00945_c")]
uppbnd(C4FBAmodel.const.NADPME)[which(react_id(C4FBAmodel.const.NADPME)=="R00945_c")]
